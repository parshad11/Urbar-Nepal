            ...
            <div class="<?php if(!empty($default_purchase_status)): ?> col-sm-4 <?php else: ?> col-sm-3 <?php endif; ?>">
              <div class="form-group">
                ...
                <div class="input-group">
                  ...
                  <?php echo Form::select('contact_id', [ $purchase->contact_id => $purchase->contact->name], $purchase->contact_id, ['class' => 'form-control', 'placeholder' => __('messages.please_select') , 'disabled', 'id' => 'supplier_id']);; ?>
            ...
            <div class="col-sm-12">
              ...
              <div class="col-sm-3">
                <div class="form-group">
                    ...
                    <br/>
                    <label>
                      <?php echo Form::checkbox('assign_delivery', 1, $purchase->assign_delivery,
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\HP\Project\FreshKtm\Freshktm-\resources\views/purchase/edit.blade.php ENDPATH**/ ?>
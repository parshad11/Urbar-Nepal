<div class="modal-header">
    ...
    <h4 class="modal-title" id="modalTitle"> <?php echo app('translator')->getFromJson('purchase.purchase_details'); ?> (<b><?php echo app('translator')->getFromJson('purchase.ref_no'); ?>:</b> #<?php echo e($purchase->ref_no, false); ?>)
    </h4>
</div>
<div class="modal-body">
  ...
  <div class="row invoice-info">
    ...
    <div class="col-sm-4 invoice-col">
      ...
      <b><?php echo app('translator')->getFromJson('purchase.purchase_status'); ?>:</b> <?php echo e(__('lang_v1.' . $purchase->status), false); ?><br>
      <b><?php echo app('translator')->getFromJson('purchase.payment_status'); ?>:</b> <?php echo e(__('lang_v1.' . $purchase->payment_status), false); ?><br>
    </div>
  </div>
        ...
        <table class="table bg-gray">
          <thead>
            <tr class="bg-green">
              ...
              <th class="text-right"><?php echo app('translator')->getFromJson('purchase.purchase_quantity'); ?></th>
...
</div><?php /**PATH C:\Users\HP\Project\FreshKtm\Freshktm-\resources\views/purchase/partials/show_details.blade.php ENDPATH**/ ?>
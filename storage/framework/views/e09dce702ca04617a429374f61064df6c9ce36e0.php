...
<section class="content">
    <?php $__env->startComponent('components.widget', ['class' => 'box-primary']); ?>
        ...
        <div class="row check_group">
            <div class="col-md-1">
                <h4><?php echo app('translator')->getFromJson( 'contact.supplier_record' ); ?></h4>
            </div>
            <div class="col-md-2">
                <div class="checkbox">
                    <label>
            ...
            <div class="col-md-9">
                <div class="col-md-12">
                    <div class="checkbox">
                        <label>
                            <?php echo Form::checkbox('permissions[]', 'record.view_own', in_array('record.view', $role_permissions),
                            [ 'class' => 'input-icheck']);; ?> <?php echo e(__( 'role.record.own.view' ), false); ?>
                ...
                <div class="col-md-12">
                    <div class="checkbox">
                        <label>
                            <?php echo Form::checkbox('permissions[]', 'record.view', in_array('record.view', $role_permissions),
                            [ 'class' => 'input-icheck']);; ?> <?php echo e(__( 'role.record.view' ), false); ?>
                ...
                <div class="col-md-12">
                    <div class="checkbox">
                        <label>
                            <?php echo Form::checkbox('permissions[]', 'record.create', in_array('record.view', $role_permissions),
                            [ 'class' => 'input-icheck']);; ?> <?php echo e(__( 'role.record.create' ), false); ?>
                ...
                <div class="col-md-12">
                    <div class="checkbox">
                        <label>
                            <?php echo Form::checkbox('permissions[]', 'record.update', in_array('record.view', $role_permissions),
                            [ 'class' => 'input-icheck']);; ?> <?php echo e(__( 'role.record.update' ), false); ?>
                ...
                <div class="col-md-12">
                    <div class="checkbox">
                        <label>
                            <?php echo Form::checkbox('permissions[]', 'record.delete', in_array('record.view', $role_permissions),
                            [ 'class' => 'input-icheck']);; ?> <?php echo e(__( 'role.record.delete' ), false); ?>
        ...
        <div class="row check_group">
        <div class="col-md-1">
          <h4><?php echo app('translator')->getFromJson( 'delivery.delivery' ); ?></h4>
        </div>
        <div class="col-md-2">
          <div class="checkbox">
              <label>
        ...
        <div class="col-md-9">
          <div class="col-md-12">
            <div class="checkbox">
              <label>
                <?php echo Form::checkbox('permissions[]', 'view_own_delivery', in_array('view_own_delivery', $role_permissions),
                [ 'class' => 'input-icheck']);; ?> <?php echo e(__( 'role.view.own.delivery' ), false); ?>
          ...
          <div class="col-md-12">
            <div class="checkbox">
              <label>
                <?php echo Form::checkbox('permissions[]', 'delivery.view', in_array('delivery.view', $role_permissions),
                [ 'class' => 'input-icheck']);; ?> <?php echo e(__( 'role.delivery.view' ), false); ?>
          ...
          <div class="col-md-12">
            <div class="checkbox">
              <label>
                <?php echo Form::checkbox('permissions[]', 'delivery.create', in_array('delivery.create', $role_permissions),
                [ 'class' => 'input-icheck']);; ?> <?php echo e(__( 'role.delivery.create' ), false); ?>
          ...
          <div class="col-md-12">
            <div class="checkbox">
              <label>
                <?php echo Form::checkbox('permissions[]', 'delivery.update', in_array('delivery.update', $role_permissions),
                [ 'class' => 'input-icheck']);; ?> <?php echo e(__( 'role.delivery.update' ), false); ?>
          ...
          <div class="col-md-12">
            <div class="checkbox">
              <label>
                <?php echo Form::checkbox('permissions[]', 'delivery.delete', in_array('delivery.delete', $role_permissions),
                [ 'class' => 'input-icheck']);; ?> <?php echo e(__( 'role.delivery.delete' ), false); ?>
          ...
          <div class="col-md-12">
            <div class="checkbox">
              <label>
                <?php echo Form::checkbox('permissions[]', 'view_own_task', in_array('view_own_task', $role_permissions),
                [ 'class' => 'input-icheck']);; ?> <?php echo e(__( 'role.view.own.task' ), false); ?>
          ...
          <div class="col-md-12">
            <div class="checkbox">
              <label>
                <?php echo Form::checkbox('permissions[]', 'task.view', in_array('task.view', $role_permissions),
                [ 'class' => 'input-icheck']);; ?> <?php echo e(__( 'role.task.view' ), false); ?>
          ...
          <div class="col-md-12">
            <div class="checkbox">
              <label>
                <?php echo Form::checkbox('permissions[]', 'task.assign', in_array('task.assign', $role_permissions),
                [ 'class' => 'input-icheck']);; ?> <?php echo e(__( 'role.task.create' ), false); ?>
          ...
          <div class="col-md-12">
            <div class="checkbox">
              <label>
                <?php echo Form::checkbox('permissions[]', 'task.update', in_array('task.update', $role_permissions),
                [ 'class' => 'input-icheck']);; ?> <?php echo e(__( 'role.task.update' ), false); ?>
          ...
          <div class="col-md-12">
            <div class="checkbox">
              <label>
                <?php echo Form::checkbox('permissions[]', 'task.delete', in_array('task.delete', $role_permissions),
                [ 'class' => 'input-icheck']);; ?> <?php echo e(__( 'role.task.delete' ), false); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\HP\Project\FreshKtm\Freshktm-\resources\views/role/edit.blade.php ENDPATH**/ ?>
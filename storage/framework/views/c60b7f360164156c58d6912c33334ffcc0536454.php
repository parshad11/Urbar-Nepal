  ...
  <div class="modal-content">
    ...
    <div class="modal-body">
      <div class="row">
        ...
        <div class="col-sm-6">
          <div class="form-group">
            <?php echo Form::label('Latitude', __( 'business.latitude' ) . ':*'); ?>

            <?php echo Form::text('latitude', null, ['class' => 'form-control', 'placeholder' => __( 'business.latitude'), 'required' ]);; ?>

          </div>
        </div>
        <div class="col-sm-6">
          <div class="form-group">
            <?php echo Form::label('Longitude', __( 'business.longitude' ) . ':*'); ?>

            <?php echo Form::text('longitude', null, ['class' => 'form-control', 'placeholder' => __( 'business.longitude'), 'required' ]);; ?>
...
<?php /**PATH C:\Users\HP\Project\FreshKtm\Freshktm-\resources\views/business_location/create.blade.php ENDPATH**/ ?>
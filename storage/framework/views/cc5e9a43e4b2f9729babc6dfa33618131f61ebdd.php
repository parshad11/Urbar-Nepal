            ...
            <table class="table table-bordered table-striped" id="business_location_table">
                <thead>
                    <tr>
                        ...
                        <th><?php echo app('translator')->getFromJson( 'business.latitude' ); ?></th>
                        <th><?php echo app('translator')->getFromJson( 'business.longitude' ); ?></th>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\HP\Project\FreshKtm\Freshktm-\resources\views/business_location/index.blade.php ENDPATH**/ ?>
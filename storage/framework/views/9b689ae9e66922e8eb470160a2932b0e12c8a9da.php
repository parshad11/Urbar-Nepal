...
<div class="row">
	<div class="col-sm-4">
		<div class="form-group">
			...
			<?php echo Form::select('select_location_id', [], $default_location->id ?? null, ['class' => 'form-control input-sm select2','placeholder' => __('messages.please_select'),
	...
	<div class="row">
		<div class="col-md-12 col-sm-12">
			<?php $__env->startComponent('components.widget', ['class' => 'box-primary']); ?>
				...
				<?php if(!empty($status) && $status == 'quotation'): ?>
				...
				<div class="row col-sm-12 pos_product_div" style="min-height: 0">
                    ...
                    <div class="col-sm-3">
             		   <div class="form-group">
							...
							<br/>
							<label>
								<?php echo Form::checkbox('assign_delivery', 1, false, 
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\HP\Project\FreshKtm\Freshktm-\resources\views/sell/create.blade.php ENDPATH**/ ?>
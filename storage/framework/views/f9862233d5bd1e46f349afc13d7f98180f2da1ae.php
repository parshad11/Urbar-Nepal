            ...
            <div class="row check_group">
                ...
                <div class="col-md-9">
                    <div class="col-md-12">
                        <div class="checkbox">
                            <label>
                                <?php echo Form::checkbox('permissions[]', 'record.view_own', false,
                    ...
                    <div class="col-md-12">
                        <div class="checkbox">
                            <label>
                                <?php echo Form::checkbox('permissions[]', 'record.view', false,
                    ...
                    <div class="col-md-12">
                        <div class="checkbox">
                            <label>
                                <?php echo Form::checkbox('permissions[]', 'record.create', false,
                    ...
                    <div class="col-md-12">
                        <div class="checkbox">
                            <label>
                                <?php echo Form::checkbox('permissions[]', 'record.update', false,
                    ...
                    <div class="col-md-12">
                        <div class="checkbox">
                            <label>
                                <?php echo Form::checkbox('permissions[]', 'record.delete', false,
            ...
            <div class="row check_group">
                ...
                <div class="col-md-9">
                    <div class="col-md-12">
                        <div class="checkbox">
                            <label>
                                <?php echo Form::checkbox('permissions[]', 'view_own_delivery', false,
                    ...
                    <div class="col-md-12">
                        <div class="checkbox">
                            <label>
                                <?php echo Form::checkbox('permissions[]', 'delivery.view', false,
                    ...
                    <div class="col-md-12">
                        <div class="checkbox">
                            <label>
                                <?php echo Form::checkbox('permissions[]', 'delivery.create', false,
                    ...
                    <div class="col-md-12">
                        <div class="checkbox">
                            <label>
                                <?php echo Form::checkbox('permissions[]', 'delivery.update', false,
                    ...
                    <div class="col-md-12">
                        <div class="checkbox">
                            <label>
                                <?php echo Form::checkbox('permissions[]', 'delivery.delete', false,
                    ...
                    <div class="col-md-12">
                        <div class="checkbox">
                            <label>
                                <?php echo Form::checkbox('permissions[]', 'view_own_task', false,
                    ...
                    <div class="col-md-12">
                        <div class="checkbox">
                            <label>
                                <?php echo Form::checkbox('permissions[]', 'task.view', false,
                    ...
                    <div class="col-md-12">
                        <div class="checkbox">
                            <label>
                                <?php echo Form::checkbox('permissions[]', 'task.assign', false,
                    ...
                    <div class="col-md-12">
                        <div class="checkbox">
                            <label>
                                <?php echo Form::checkbox('permissions[]', 'task.update', false,
                    ...
                    <div class="col-md-12">
                        <div class="checkbox">
                            <label>
                                <?php echo Form::checkbox('permissions[]', 'task.delete', false,
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\HP\Project\FreshKtm\Freshktm-\resources\views/role/create.blade.php ENDPATH**/ ?>
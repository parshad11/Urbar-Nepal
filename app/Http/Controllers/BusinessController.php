        ...
        if (request()->ajax()) {
            ...
            $locations = $query->where(function ($query) use ($term) {
                $query->where('name', 'like', '%' . $term .'%')
                        ...
                        ->select('business_locations.id', DB::raw("CONCAT(name, ' (', business_locations.location_id, ')') as text"),DB::raw("CONCAT(business_locations.landmark,' ',business_locations.city,', ',business_locations.state,', ',business_locations.country,', ',business_locations.zip_code) AS business_location_address"))
                        ->get();

    ...
    public static function customerNotifications()
    {
        return [
            'new_customer' => [
                ...
                'extra_tags' => ['{business_name}', '{business_logo}','{ecommerce_login}', '{name}', '{location_name}', '{location_address}', '{location_email}', '{location_phone}', '{location_custom_field_1}', '{location_custom_field_2}', '{location_custom_field_3}', '{location_custom_field_4}']
            ],
            'new_sale' => [

        ...
        <div class="row">
            <div class="col-sm-4">
                    <div class="form-group">
                        ...
                        {!! Form::select('location_id',$business_locations, $task->location_id, ['class' => 'form-control select2', 'placeholder' => __('messages.please_select'), 'disabled']); !!}
                    </div>
            </div>
            ...
            <div class="col-sm-4 ">
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            {!! Form::select('delivery_person_id',$task->delivery_person_id, ['class' => 'form-control', 'placeholder' => __('messages.please_select'), 'required', 'id' => 'delivery_person_id']); !!}

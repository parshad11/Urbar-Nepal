...
<section class="content">
    <a href="{{ route('ecom_blog') }}" class="btn btn-sm btn-success">Go Back</a><br><br>
<form action="{{ route('ecom_blog_update', $blog_info->id)}}" class="form" method="POST" enctype="multipart/form-data">
    @csrf
    @method('put')

@php
    ...
    // $categories = array_except($array, array('keys', 'to', 'remove'));
    // dd($categories);
@endphp
...
@section('content')
    ...
    <section class="three-columns mb">
        ...
        <div class="container-fluid">
            <div class="row col-three owl-carousel">
                ...
                <div class="column">
                    <a href=""><img src="images/shop/04.jpg" alt=""></a>
                </div>
                <div class="column">
    ...
    <section id="popular-category">
       ...
       <!-- modernizr -->
       <script src="{{ asset('js/modernizr-2.6.2.min.js?v=' .$asset_v) }}"></script>
        

       <!-- jQuery -->
       <script src="{{ asset('js/jquery.min.js?v=' .$asset_v) }}"></script>
   
       <!-- Bootstrap Core JavaScript -->
       <script src="{{ asset('js/bootstrap.min.js?v=' .$asset_v) }}"></script>
   
       <!-- All Included JavaScript -->
       <script src="{{ asset('js/bootstrap-dropdownhover.min.js?v=' .$asset_v) }}"></script>
       <script src="{{ asset('js/jquery-scrolltofixed-min.js?v=' .$asset_v) }}"></script>
       <script src="{{ asset('js/owl.carousel.min.js?v=' .$asset_v) }}"></script>
       <script src="{{ asset('js/jarallax.min.js?v=' .$asset_v) }}"></script>
       <script src="{{ asset('js/jquery.countup.min.js?v=' .$asset_v) }}"></script>
       <script src="{{ asset('js/jquery.waypoints.min.js?v=' .$asset_v) }}"></script>
       <script src="{{ asset('js/jquery.ripples.js?v=' .$asset_v) }}"></script>
       <script src="{{ asset('js/dyscrollup.js?v=' .$asset_v) }}"></script>
       <script src="{{ asset('js/VideoPlayerPopUp.js?v=' .$asset_v) }}"></script>
       <script src="{{ asset('js/animated-text.js?v=' .$asset_v) }}"></script>
       <script src="{{ asset('js/jquery.zoomslider.min.js?v=' .$asset_v) }}"></script>
       <script src="{{ asset('js/YouTubePopUp.jquery.js?v=' .$asset_v) }}"></script>
       <script src="{{ asset('js/lightbox.min.js?v=' .$asset_v) }}"></script>
       <script src="{{ asset('js/imagesloaded.min.js?v=' .$asset_v) }}"></script>
       <script src="{{ asset('js/jquery.filterizr.min.js?v=' .$asset_v) }}"></script>
...
<script src="https://cdnjs.cloudflare.com/ajax/libs/slick-carousel/1.9.0/slick.min.js"></script> 
   ...
   <script src="{{ asset('js/app.min.js?v=' .$asset_v) }}"></script>

...
<form action="{{ route('ecommerce_about_store') }}" class="form" method="POST" enctype="multipart/form-data">
    @csrf
    {{-- Banner image --}}
        ...
        <div class="col-md-10">
            <div class="row" style="margin-bottom: 10px;">
                <div class="col-md-12" style="padding:0 10px 0 0;">
                    <textarea name="what_description"  required placeholder="Mission and Vision ..."></textarea>
                </div>
            </div>
            <div class="row">

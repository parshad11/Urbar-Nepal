...
<form action="{{ route('homepage-setting.store') }}" class="form" method="POST" enctype="multipart/form-data">
    @csrf
    {{-- logo image --}}
        ...
        <div class="row form-group">
            ...
            <div class="col-md-10">
                ...
                <div class="row" style="margin-bottom: 10px;">
                    ...
                    <div class="col-md-8" style="padding:0 10px 0 0;">
                        <input type="url" name="sitelink[]" class="form-control" placeholder="Instagram Page Link...?">
                    </div>
                </div>
                <div class="row" style="margin-bottom: 10px;">
                    <div class="col-md-4" style="padding:0 10px 0 0;">

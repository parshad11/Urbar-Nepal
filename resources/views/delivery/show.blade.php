               ...
               <div class="col-md-12">
                    <div class="nav-tabs-custom">
                         <ul class="nav nav-tabs nav-justified">
                              <li class="active">
                                   <a href="#task_details_tab" data-toggle="tab" aria-expanded="true"><i
                                                class="fas fa-info-circle"
                                                aria-hidden="true"></i> @lang( 'delivery.delivery_details')</a>
                              </li>

                              <li>
                                   <a href="#delivery_location_detail_tab" data-toggle="tab" aria-expanded="true"><i
                                                class="fas fa-map-marker"
                                                aria-hidden="true"></i> @lang('delivery.location_details')</a>
                              </li>
                              @can('task.assign')
                                   <li>
                                        <a href="#delivery_person_tab" data-toggle="tab" aria-expanded="true"><i
                                                     class="fas fa-user"
                                                     aria-hidden="true"></i> @lang('delivery.delivery_person_details')
                                        </a>
                                   </li>
                              @endcan
                         </ul>
                              ...
                              <div class="tab-pane" id="delivery_location_detail_tab">
                                   <div class="row">
                                        <div class="col-md-12" style="display:flex;justify-content: space-between;">
                                             ...
                                             <div class="col-md-8 pull-right">
                                                  ...
                                                  <input type="hidden" id="pickup_latitude"
                                                         value="{{ $delivery->pickup_latitude }}"
                                                         name="pickup_latitude">
                                                  <input type="hidden" id="pickup_longitude"
                                                         value="{{ $delivery->pickup_longitude }}"
                                        ...
                                        <div class="col-md-12" style="display:flex;justify-content: space-between;">
                                             ...
                                             <div class="col-md-8">
                                                  <strong>@lang('delivery.location_view'):</strong><br>
                                                  <input type="hidden" id="shipping_latitude"
                                                         value="{{ $delivery->shipping_latitude }}"
                                                         name="shipping_latitude">
                                                  <input type="hidden" id="shipping_longitude"
                                                         value="{{ $delivery->shipping_longitude }}"

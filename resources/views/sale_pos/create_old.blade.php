                    ...
                    <div class="col-md-4 col-sm-6">
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                {!! Form::text('transaction_date', $default_datetime, ['class' => 'form-control',
                                'readonly', 'required']); !!}
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-4 col-sm-6">
                        <div class="form-group">
                            <div class="input-group">
                                ...
                                'hidden_price_group']) !!}
                                {!! Form::select('price_group', $price_groups, $selected_price_group, ['class' =>
                    ...
                    <div class="col-md-4 col-sm-6">
                        <div class="form-group">
                            <div class="input-group">
                                ...
                                {!! Form::select('types_of_service_id', $types_of_service, null, ['class' =>

...
<section class="content">
    <a href="{{ route('cms_blog_form') }}" class="btn btn-sm btn-success">Back to Blog</a><br><br>
<div class="row">
    <div class="col-md-4">
        <form action="{{ route('cms_blogcat_store')}}" class="form" method="POST" enctype="multipart/form-data">
            @csrf
            ...
            <tbody>
                ...
                @foreach ($categories as $key => $category)
                    <tr>
                        ...
                        <td>
                            <a href="{{ route('cms_blogcat_edit', $category->id) }}" class="btn btn-sm btn-border-success"  data-toggle="modal" data-target="#categoryModal"><i class="fa fa-paper-plane"></i>&nbsp;Edit</a>
                            <a href="{{ route('cms_blogcat_delete', $category->id) }}" class="btn btn-sm btn-border-danger"><i class="fa fa-trash"></i>&nbsp;Delete</a>
                        </td>
                    </tr>
                @endforeach
                @else

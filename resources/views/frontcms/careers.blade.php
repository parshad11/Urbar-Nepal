...
@section('content')
    ...
    <section class="careers row">
        ...
        <div class='col-md-6 careers-nav careers-nav2'>
            <img src="{{asset('cms/images/careers_back.jpg')}}" alt="">
        </div>
                        ...
                        <div class="panel panel-default">
                            ...
                            <div id="collapse{{$career->id}}" class="panel-collapse collapse job-description" role="tabpanel"
                                ...
                                <div class="panel-body job-detail">
                                    ...
                                    <br>
                                    <a href="{{$career->form_link}}" target="_blank" class="btn btn-primary job-apply">Apply
                                        Now</a>
                                </div>
                            </div>
                            @endforeach
    ...
    <section class="job-benefits">
        ...
        <div class="row benefits">
            ...
            <div class="">
                ...
                <div class="benefits-detail">
                    We encourage more sports, gathering and other social recreational activities to promote team work
                    and mental

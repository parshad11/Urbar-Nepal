    ...
    <td>
        <table class="table table-condensed table-bordered blue-header variation_value_table">
            ...
            <tr>
                ...
                <td>
                    {!! Form::text('product_variation[' . $row_index .'][variations][0][market_price]', null, ['class' => 'form-control input-sm variation_market_price', 'required']); !!}
                </td>
                <td class="{{$class}}">
                ...
                <td>{!! Form::file('variation_images_' . $row_index .'_0[]', ['class' => 'variation_images', 'accept' => 'image/*']); !!}</td>
                <td>
